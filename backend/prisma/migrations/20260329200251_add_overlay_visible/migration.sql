...
CREATE TABLE "new_GiveawaySession" (
    ...
    "overlayVisible" BOOLEAN NOT NULL DEFAULT true,
...
INSERT INTO "new_GiveawaySession" ("allowDuplicateEntries", "announceWinnerInChat", "broadcasterId", "createdAt", "entryCommand", "excludeBroadcaster", "followerOnlyMode", "id", "lastSpinPayloadJson", "lastWinnerId", "leaveCommand", "maxEntriesPerUser", "minimumAccountAgeDays", "minimumFollowageDays", "overlayKey", "removeWinnerAfterDraw", "spinCountdownSeconds", "status", "subscriberOnlyMode", "title", "updatedAt") SELECT "allowDuplicateEntries", "announceWinnerInChat", "broadcasterId", "createdAt", "entryCommand", "excludeBroadcaster", "followerOnlyMode", "id", "lastSpinPayloadJson", "lastWinnerId", "leaveCommand", "maxEntriesPerUser", "minimumAccountAgeDays", "minimumFollowageDays", "overlayKey", "removeWinnerAfterDraw", "spinCountdownSeconds", "status", "subscriberOnlyMode", "title", "updatedAt" FROM "GiveawaySession";
